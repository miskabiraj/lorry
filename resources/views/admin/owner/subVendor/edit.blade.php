...
@section('content')
    <!-- #END# Search Bar -->
    <!-- Top Bar -->
    <form method="post" action="{{ route('admin.updateSubVendor',$customer->id) }}">
        {{csrf_field()}}
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" id="phone_no" name="contact_number" class="form-control" value="{{$customer->contact_number}}" minlength="10" maxlength="10" placeholder="Contact Number" required autofocus>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <button type="submit" class="btn btn-primary col-md-12 waves-effect">Update SubVendor</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
